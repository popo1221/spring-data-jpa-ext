...
public class ToBigDecimalOperator<T> extends AbstractOperator<T> implements ExpressionOperator<T> {
    public ToBigDecimalOperator(Object value, List<Operator<T>> children) {
    ...
    public ExpressionHolder toExpressionHolder() {
        ...
        return new ToBigDecimalExpressionHolder(x);
    }
}