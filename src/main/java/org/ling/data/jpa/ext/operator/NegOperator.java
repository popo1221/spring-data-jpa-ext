...
public class NegOperator<T> extends AbstractOperator<T> implements ExpressionOperator<T> {
    public NegOperator(Object value, List<Operator<T>> children) {
    ...
    public ExpressionHolder<?> toExpressionHolder() {
        ...
        return new NegExpressionHolder(x);
    }
}