...
public class OrOperator<T> extends AbstractOperator<T> implements SpecificationOperator<T> {

    public OrOperator(Object value, List<Operator<T>> children) {
    ...
    public Specification<T> toSpecification() {
        ...
        for (Operator<T> operator : this.getChildren()) {
            ...
            if (current == null) {
                ...
                current = current.or(specificationOperator.toSpecification());
            }
        }
