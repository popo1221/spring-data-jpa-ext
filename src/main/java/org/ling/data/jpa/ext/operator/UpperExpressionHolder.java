...
public class UpperExpressionHolder implements ExpressionHolder<String> {
    ...
    public Expression<String> getExpression(Root<?> root,
        ...
        return criteriaBuilder.upper(prev.getExpression(root, criteriaQuery, criteriaBuilder));
    }
}
