...
public class ToBigIntegerOperator<T> extends AbstractOperator<T> implements ExpressionOperator<T> {
    public ToBigIntegerOperator(Object value, List<Operator<T>> children) {
    ...
    public ExpressionHolder toExpressionHolder() {
        ...
        return new ToBigIntegerExpressionHolder(x);
    }
}