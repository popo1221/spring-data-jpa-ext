...
public class ToDoubleOperator<T> extends AbstractOperator<T> implements ExpressionOperator<T> {
    public ToDoubleOperator(Object value, List<Operator<T>> children) {
    ...
    public ExpressionHolder toExpressionHolder() {
        ...
        return new ToDoubleExpressionHolder(x);
    }
}