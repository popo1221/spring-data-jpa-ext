...
public class ToFloatOperator<T> extends AbstractOperator<T> implements ExpressionOperator<T> {
    public ToFloatOperator(Object value, List<Operator<T>> children) {
    ...
    public ExpressionHolder toExpressionHolder() {
        ...
        return new ToFloatExpressionHolder(x);
    }
}